...
public class ModRegistry {
    ...
    public static final Holder.Reference<BlockEntityType<CraftingTableBlockEntity>> CRAFTING_TABLE_BLOCK_ENTITY = REGISTRY.registerBlockEntityType("crafting_table", () -> {
        BlockEntityType.Builder<CraftingTableBlockEntity> builder = BlockEntityType.Builder.of(CraftingTableBlockEntity::new);
        builder.validBlocks = BlockConversionHandler.BLOCK_CONVERSIONS.values();
        return builder;
    });
    public static final Holder.Reference<MenuType<VisualCraftingMenu>> CRAFTING_MENU_TYPE = REGISTRY.registerMenuType("crafting", () -> VisualCraftingMenu::new);
